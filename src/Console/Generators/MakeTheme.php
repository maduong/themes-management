...
class MakeTheme extends Command
{
     ...
     * @var string
     */
    protected $description = 'Edutalk theme generator.';
    ...
    protected function step1()
    {
        ...
        $this->container['name'] = $this->ask('Name of theme:', 'Edutalk ' . $this->container['alias']);
        ...
        $this->container['namespace'] = $this->ask('Namespace of theme:', 'Edutalk\\Themes\\' . studly_case($this->container['alias']));
    ...
    {
        $directory = Edutalk_themes_path($this->themeFolderName);
        ...
        foreach ($files as $file) {
            ...
            $filePath = Edutalk_themes_path($this->themeFolderName . '/' . $file->getRelativePathname());
