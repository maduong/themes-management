...
@section('content')
    <div class="layout-2columns sidebar-left">
        <div class="column left">
            <ul class="list-group">
                @php do_action(BASE_ACTION_META_BOXES, 'top-sidebar', Edutalk_THEME_OPTIONS . '.index', null) @endphp
                ...
                @endforeach
                @php do_action(BASE_ACTION_META_BOXES, 'bottom-sidebar', Edutalk_THEME_OPTIONS . '.index', null) @endphp
            </ul>
        </div>
        <div class="column main">
            <div class="tab-content">
                @foreach(cms_theme_options()->export() as $key => $group)
                    ...
                    <div class="tab-pane active">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-footer">
                                {!! Form::button(trans('edutalk-core::base.form.save_change'), [
                    ...
                    @endif
                @endforeach
                @php do_action(BASE_ACTION_META_BOXES, 'main', Edutalk_THEME_OPTIONS . '.index', null) @endphp
            </div>
        </div>
    </div>
@endsection
