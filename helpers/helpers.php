...
if (!function_exists('Edutalk_themes_path')) {
    /**
     * @param string $path
     * @return string
     */
    function Edutalk_themes_path($path = '')
    {
...
if (!function_exists('themes_management')) {
    /**
     * @return \Edutalk\Base\ThemesManagement\Support\ThemesManagement
     */
    function themes_management()
    {
        return \Edutalk\Base\ThemesManagement\Facades\ThemesManagementFacade::getFacadeRoot();
    }
}
